...
import crud.backend.DepartmentsRepo;
...
@UIScope
@SpringComponent
public class PersonForm extends AbstractForm<Departments> {
    ...
    PersonForm(DepartmentsRepo r, EventBus.UIEventBus b) {
        ...
        setSavedHandler(departments -> {
            ...
            eventBus.publish(this, new PersonModifiedEvent(departments));
        });
